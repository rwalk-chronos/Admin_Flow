...
async function reviewDetail(reviewId) {
  ...
  const drawReadMode = (updated = false) => {
    ...
    packetHost.append(identity, section("Summary", [element("p", { className: "packet-summary", text: packet.summary }), element("p", { className: "summary-source", text: summarySource })]), section("Key information", [factList()]), section("Needs your attention", [attention], "packet-section attention-section"), section("Original document", [originalLink()]), section("What will happen next", plan, "packet-section action-plan-card"), section("Your decision", decisionChildren, "packet-section decision-section"));
